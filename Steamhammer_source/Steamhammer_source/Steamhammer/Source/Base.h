...
private:
    ...
    static const int BaseResourceRange = 12;
...
public:
    ...
    // Various distances.
    GridDistances & getDistances() { return distances; };
    ...
    BWAPI::Unitset getRemainingMinerals() const;                        // only those with minerals left
